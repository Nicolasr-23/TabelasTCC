...
VALUES 
(1, N'João Oliveira', 'rm12345', N'Informática', 'DEZEMBRO/2026', '2006-08-15', GETDATE(), 'INATIVO'),
(2, 'Cleiton dos Santos', 'rm12346', N'Informática', 'DEZEMBRO/2026', '2006-07-22', GETDATE(), 'ATIVO'),
(3, 'Jorge da Silva', 'rm12347', N'Informática', 'DEZEMBRO/2026', '2006-09-10', GETDATE(), 'ATIVO')
...
(3, 'CodeStorm', '11.222.333/0001-82', N'Escritório central', '12345678', '210', 'https://codestorm.com', '11988880000', GETDATE(), 'INATIVO'),
(4, 'Biotec Pharma', '11.222.333/0001-83', N'Laboratório principal', '12345678', '220', 'https://biotecpharma.com', '11987770000', GETDATE(), 'INATIVO')
...
VALUES 
(1, 'Vaga X', 'Desenvolvedor web','São Paulo', 'Centro', '30 horas', '600 reais', N'Informática', GETDATE(), 'ATIVO'),
(2, 'Vaga Y', 'Engenheiro de software', 'Campinas', 'Taquaral', '29 horas', '700 reais', N'Informática', GETDATE(), 'ATIVO'),
(3, 'Vaga Z', 'Analista de sistemas', 'Santos', 'Ponta da Praia', '35 horas', '750 reais', N'Informática', GETDATE(), 'ATIVO')
